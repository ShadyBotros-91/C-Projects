...
/*Defining a private 32-bit variable for storing the time to be used with clock and alarm times*/
...
/**calculating the time in a more human-friendly way*/
...
/* An instance of the time structure representing the current actual time */

struct time_t currentTime;

/* An instance of the time structure representing the alarm time to be set by the user*/
